                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-block btn-warning" href="{{ route('postEdit', $posts->id) }}"><i class="fa fa-pencil-alt"></i></a><br>
                                            <form id="delete-post-{{ $posts->id }}" action="{{ route('deletePost', $posts->id) }}" method="post">@csrf</form>
